...
<html xmlns="http://www.w3.org/1999/xhtml" lang="{{ app()->getLocale() }}" xml:lang="pt-br">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/assets/css/federais/urna.css" />
    <link type="text/css" rel="stylesheet" href="/assets/css/federais/senador.css" />
    ...
    <script src="http://cdn.tse.jus.br/estatico/js/plugin-iframe3D-1.1.js"></script>
    ...
    <body>
        <input type="hidden" id="codigoCargo" value="3" data-turno="1" />
        <div class="listaConcorrentes">
            ...
            <button type="button" id="pag1" aria-label="Pagina 1">
                <img id="p1a" src="image/1-ativo.png" style="display: none;"/><img id="p1i" src="image/1-inativo.png" style="display: none;"/>
            </button><button type="button" id="pag2" aria-label="Pagina 2">
                <img id="p2a" src="image/2-ativo.png" style="display: none;"/><img id="p2i" src="image/2-inativo.png" style="display: none;"/>
            </button>
            </div>
            <img src="" id="imagemCandidatos" alt="imagem cola dos candidatos" style="display: none;">
        </div>
        <div class="sr-only">
            <a href="#conteudo" name="conteudo" accesskey="1"><span><h1>ConteÃºdo principal [1]</h1></span></a>
        </div>
        <div id="topo-pag">
        ...
        <div id="conteudo">
            ...
            <img id="n_1" alt="tecla número 1" src="/imagem/pecas/n1.jpg" width="51" height="41" border="0">
            <img id="n_2" alt="tecla número 2" src="/imagem/pecas/n2.jpg" width="48" height="41" border="0">
            <img id="n_3" alt="tecla número 3" src="/imagem/pecas/n3.jpg" width="48" height="41" border="0">
            <img id="ladoDirTec" alt="lado direito teclado" src="/imagem/pecas/ladoDirTec.jpg" width="26" height="152" border="0">
            <img id="n_4" alt="tecla número 4" src="/imagem/pecas/n4.jpg" width="51" height="42" border="0">
            <img id="n_5" alt="tecla número 5" src="/imagem/pecas/n5.jpg" width="48" height="42" border="0">
            <img id="n_6" alt="tecla número 6" src="/imagem/pecas/n6.jpg" width="48" height="42" border="0">
            <img id="n_7" alt="tecla número 7" src="/imagem/pecas/n7.jpg" width="51" height="41" border="0">
            <img id="n_8" alt="tecla número 8" src="/imagem/pecas/n8.jpg" width="48" height="41" border="0">
            <img id="n_9" alt="tecla número 9" src="/imagem/pecas/n9.jpg" width="48" height="41" border="0">
            <img id="ptabaixo7" alt="parte abaixo 7" src="/imagem/pecas/ptabaixo7.jpg" width="51" height="36" border="0">
            <img id="n_0" alt="tecla número 0" src="/imagem/pecas/n0.jpg" width="56" height="36" border="0">
            <img id="ptabaixo9" alt="parte abaixo 9" src="/imagem/pecas/ptabaixo9.jpg" width="40" height="28" border="0">
            <img id="confirma" alt="tecla confirma" src="/imagem/pecas/confirma.jpg" width="66" height="49" border="0" data-proximo="senador.html">
            <img id="branco" alt="tecla branco" src="/imagem/pecas/branco.jpg" width="63" height="41" border="0">
            <img id="corrige" alt="tecla corrige" src="/imagem/pecas/corrige.jpg" width="63" height="41" border="0">
        ...
        <div id="painel">
            ...
            <div id="labelCanditato">Senador</div>
			<div id="suplent1">
				<div id="cxFotoSup1"><img id="fotoSup1" src="" width="75" height="105"/></div>
				<div id="labelSuplente1">1° Suplente</div>
			</div>
			<div id="suplent2">
				<div id="cxFotoSup2"><img id="fotoSup2" src="" width="75" height="105"/></div>
				<div id="labelSuplente2">2° Suplente</div>
			</div>
            <div id="cargo">Senador</div>
            <span id="habilitaNumeros">true</span>
            <div id="numeros">
                <div id="numeroLabel">N&uacute;mero:</div>
                <div id="cxNumero1" class="cxNumero"></div>
            ...
            <div id="suplente1">
                <div id="suplente1Label">1° Suplente:</div>
                <div id="suplente1Nome"></div>
            </div>
            <div id="suplente2">
                <div id="suplente2Label">2° Suplente:</div>
                <div id="suplente2Nome"></div>
            </div>
