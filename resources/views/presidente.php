...
<html xmlns="http://www.w3.org/1999/xhtml" lang="{{ app()->getLocale() }}" xml:lang="pt-br">
  <head>
    ...
    <body>
        <input type="hidden" id="codigoCargo" value="1" data-turno="1" />
        ...
        <div id="painel">
            ...
            <div id="cxFoto"><img id="foto" alt="caixa foto" src="" width="101" height="145"/></div>
            <div id="labelCanditato">Presidente</div>
            <div id="cxFotoVice"><img id="fotoVice" src="" width="75" height="105" /></div>
            <div id="labelVice">Vice-Presidente</div>
            ...
            <div id="vice">
                <div id="viceLabel">Vice-Presidente:</div>
                <div id="viceNome"></div>
            </div>
            ...
            <div id="libras">&nbsp;</div>
            <div id="audioAtivado">
                <span id="textoAudioAtivado">Áudio ativado</span><img src="image/audioHabilitado.png" alt="imagem �udio ativado" id="imagemAudioAtivado"></img>
            </div>
        </div>
